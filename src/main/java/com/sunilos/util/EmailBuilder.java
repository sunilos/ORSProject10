...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		msg.append("<H1>Hi! Greetings from SunilOS Infotech Pvt Ltd!</H1>");
		msg.append(
		...
		msg.append(
				"<P>Log in today at <a href='http://ors.sunilos.com'>http://ors.sunilos.com</a> with your following credentials:</P>");
		...
		msg.append("<P><a href='http://www.sunilos.com' >- SunilOS Infotech Pvt Ltd</a></P>");
	...
	public static String getForgetPasswordMessage(HashMap<String, String> map) {
		...
		msg.append("<P><B>To access account your Login Id : " + map.get("login") + "<BR>" + " Password : "
